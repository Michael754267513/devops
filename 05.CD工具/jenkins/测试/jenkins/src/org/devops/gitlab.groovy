...
def HttpReq(reqType,reqUrl,reqBody){
    def gitServer = "http://gitlab.handpay.com.cn/api/v4"
    withCredentials([usernameColonPassword(credentialsId: 'gitlab-api-token', variable: 'gitlab-api-token')]) {
      result = httpRequest customHeaders: [[maskValue: true, name: 'Private-Token', value: "${gitlab-api-token}"]], 
                httpMode: reqType, 
